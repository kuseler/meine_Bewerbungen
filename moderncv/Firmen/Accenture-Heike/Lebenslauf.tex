...
% recipient data
\recipient{
Accenture Dienstleistungen GmbH}{Campus Kronberg 1\\D-61476 Kronberg im Taunus}
\date{\today}
...
% %% Example usages:
% \cvskillentry*{Coding:}{2}{Python3}{4}{Coding-Challenges und Informatikunterricht}
...
% \cvskillentry*{Office:}{2}{Excel}{6}{Erweiterte Fähigkeiten in Excel}
