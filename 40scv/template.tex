...
% personal website
\cvsite{https://kimimueller.de}
% email address
\cvmail{kimi-mueller@proton.me}
% pgp key
...
\addtofrontsidebar{
	...
	\sidesection{Hard Skills}
		...
		\pointskill{\faDesktop}{Bash}{1}[5]
			\skill[1.8em]{\faCompress}{Grundkenntnisse im Skripting}
		\pointskill{\faTable}{SQL (MariaDB)}{1}[5]
			\skill[1.8em]{\faCompress}{Grundkenntnisse in Abfragen und Verwaltung}
